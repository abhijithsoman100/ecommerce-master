  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        const SizedBox(height: Sizes.spaceBtwItems,),
        ReadMoreText("The user interface was quite awesome good work Abhi you can do more like this",
         ...
         TRoundedContainer(
           ...
           child: Column(
             children: [
               ...
               const SizedBox(height: Sizes.spaceBtwItems,),
               ReadMoreText(
                 "The user interface was quite awesome good work Abhi you can do more like this",
                 trimLines: 2,
